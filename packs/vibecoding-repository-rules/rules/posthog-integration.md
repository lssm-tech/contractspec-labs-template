...
- Run `/audit-observability` to scan for missing analytics tracking, inconsistent event naming, and uncovered user interactions.
- The `create-feature` skill scaffolds new services and components with analytics.track calls from day one.
- See `observability.md` for the broader structured logging and metrics standards.
